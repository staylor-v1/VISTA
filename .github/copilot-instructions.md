...
- Columns are fully dynamic: Filename (always), then one column per unique `metadata_json` key found across all project images, then Image Classes, then Comment. No hardcoded field names.

...
## Current milestone
- **PR-16-M20**: clone defect-name uniqueness contract hardening for malformed successful clone payloads that contain duplicate defect names.
...
- Relational-integrity hardening prevents duplicate cloned modality/view IDs, duplicate defect names, and unknown part-view modality references from silently hydrating and destabilizing downstream save/edit workflows.
...
- [x] `PR-16-M20` clone defect-name uniqueness contract hardening.
- [ ] `PR-16-M21+` pending explicit approval of next feature-request contract.

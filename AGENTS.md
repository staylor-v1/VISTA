...
4. **QA / Tester**
   ...
   - Test should be exhaustive and end-to-end from user actions and data to screen shots upon which you perform visual analytics to confirm that expected UI components and behaviors exist from the point of view of an end user. 
